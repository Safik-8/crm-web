...
import {
  ...
  ClipboardList, UserCheck, GitBranch, CalendarClock, ArrowLeft
} from 'lucide-react';
        ...
        >
          ...
          <div className="bg-white p-4 border border-slate-200 shrink-0 flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div className="flex items-center gap-3 flex-wrap">
              ...
              {/* Status Pill */}
              {lead.status?.name && (
                <span className="inline-flex items-center gap-1.5 px-3 py-1 bg-rose-50 border border-rose-200/60 text-rose-600 rounded-full text-xs font-medium">
