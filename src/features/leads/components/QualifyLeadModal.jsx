...
const QualifyLeadModal = ({ lead, isOpen, onClose, onQualified }) => {
  ...
  useEffect(() => {
    if (lead?.qualification) {
      setFormData({
        budgetAvailable: lead.qualification.budgetAvailable || false,
        interestLevel: lead.qualification.interestLevel || 'LOW',
        purchaseTimeline: lead.qualification.purchaseTimeline || '',
        decisionMakerAvailable: lead.qualification.decisionMakerAvailable || false,
        productFit: lead.qualification.productFit || false,
        status: lead.qualification.status || '',
        notes: lead.qualification.notes || '',
        remarks: lead.qualification.remarks || ''
      });
    }
  }, [lead]);
  ...
  return (
    <DynamicFormModal
      ...
      size="md"
    >
      <div className="flex flex-col gap-4 max-h-[calc(100vh-220px)] overflow-y-auto overflow-x-hidden p-2 -m-2 scroll-smooth">
