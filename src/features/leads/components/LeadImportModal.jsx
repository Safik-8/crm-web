                ...
                <div className="border-t border-slate-100 pt-4 space-y-3">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="p-3 bg-slate-50 rounded-xl border border-slate-100">
                      ...
                      <span className="text-xs font-semibold text-slate-600 mt-1 block">Lead Name, Mobile Number, Lead Source, Interested Service</span>
                    </div>
                    <div className="p-3 bg-slate-50 rounded-xl border border-slate-100">
              ...
              <div className="space-y-6 animate-fadeIn">
                      ...
                      <table className="min-w-full divide-y divide-slate-200">
                        <thead className="bg-slate-50">
                          <tr>
                            ...
                            <th className="px-3 py-2 text-left text-[10px] font-extrabold text-slate-400 uppercase tracking-wider">Service</th>
                ...
                {previewData.errorReport && previewData.errorReport.length > 0 && (
                  <div className="space-y-2">
                    ...
                    <div className="bg-slate-50 border border-slate-200 rounded-2xl p-4 max-h-[200px] overflow-y-auto space-y-2.5">
                    ...
                    <table className="min-w-full divide-y divide-slate-200">
                      <thead className="bg-slate-50 sticky top-0 z-10">
                        <tr>
                          ...
                          <th className="px-4 py-3 text-left text-[10px] font-extrabold text-slate-400 uppercase tracking-wider bg-slate-50">Service</th>
