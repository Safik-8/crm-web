...
const OrgChart = ({ users, currentUser }) => {
  ...
  return (
    <div className="bg-white p-8 md:p-12 border border-slate-200 overflow-x-auto overflow-y-hidden min-h-[600px] relative touch-pan-x [&::-webkit-scrollbar]:hidden [-ms-overflow-style:'none'] [scrollbar-width:'none']">
