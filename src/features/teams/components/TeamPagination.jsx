// src/features/teams/components/TeamPagination.jsx
...
const TeamPagination = ({ pagination, onPageChange, isLoading }) => {
            ...
            {pageRange.map((p, idx) =>
              p === '…' ? (
                ...
                <button
                  ...
                  disabled={isLoading}
                  className={`h-8 w-8 flex items-center justify-center rounded-lg text-sm font-semibold transition-all cursor-pointer
                    ${p === page
