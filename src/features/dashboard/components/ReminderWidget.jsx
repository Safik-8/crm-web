          ...
          return (
            ...
            >
              ...
              {onViewFollowups && (
                <button
                  type="button"
                  onClick={() => onViewFollowups(filter)}
                  className={`mt-auto flex items-center gap-1 text-[11px] font-semibold transition-colors ${isUrgent ? 'text-red-600 hover:text-red-700' : 'text-slate-500 hover:text-slate-700'}`}
                >
