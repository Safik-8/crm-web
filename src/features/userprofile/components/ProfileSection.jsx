...
export const ProfileSection = ({ title, description, icon: Icon, children }) => {
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
      ...
      <div className="lg:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-6 bg-white p-5 sm:p-6 border border-zinc-200 shadow-sm hover:bg-zinc-50/50 transition-colors duration-200">
        {children}
      </div>
    </div>
  );
