      ...
      <div className="bg-white p-6 flex flex-col gap-4">
        ...
        <div className="flex justify-end gap-2.5 pt-2 border-t border-slate-100 mt-2">
          ...
          <button
            ...
            onClick={onConfirm}
            disabled={isLoading}
            className={`inline-flex items-center justify-center rounded-xl font-bold text-[13px] px-5 py-2.5 text-white transition-all shadow-sm cursor-pointer select-none ${
              isDanger
